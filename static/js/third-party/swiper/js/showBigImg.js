...
;(function(){
    var bigPicShow = {
                ...
                $(listImg).each(function(index,element){
                    ...
                    $(element).find("img:not(.notShow)").each(function(index,ele){
                        ...
                        $(ele).on("click",function(event){
                             ...
                             * */
                            options.imgElementCallBack && typeof options.imgElementCallBack=="function" && options.imgElementCallBack();
                        });
                    });
                })
            });
         ...
         * 拼接swiper结构并初始化
         * */
        addSwiperDom: function (str,index,swiperDom) {
            var swiperDom =  swiperDom ? swiperDom :
            '<div id="EV-swiper">' +
