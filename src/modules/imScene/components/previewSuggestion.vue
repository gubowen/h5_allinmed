          ...
          <section class="doctor-list">
            ...
            >
              ...
              <section class="doctor-item-bottom" v-if="item.isFreeTimes">
                <span data-alcode='e132' class="go-consult" @click="queryConsult(index,'free')"
                      v-if="item.adviceStatus==='1' && item.adviceNum && !item.isRefuse" :sps-data="getSpsData(item)">免费问诊</span>
              ...
              <section class="doctor-item-bottom" v-else-if="!item.isFreeTimes">
                <span data-alcode='e132' class="go-consult" @click="queryConsult(index,'pay')"
                      v-if="item.adviceStatus==='1' && item.adviceNum && !item.isRefuse" :sps-data="getSpsData(item)">去问诊</span>
                <span class="general-money">{{item.generalPrice}}元</span>
              </section>
            </section>
          </section>
