    ...
    <section class="main-inner-content">
      ...
      <section class="feedback-main">
        <section class="question">
          ...
          <p class="question-type" @click.stop="selectParam.service=!selectParam.service" :class="{'on':selectParam.service}"><span>服务问题</span></p>
          <p class="question-description" >医生回复慢回复质量差、推荐的医生不合理</p>
          <p class="question-type" @click.stop="selectParam.put=!selectParam.put" :class="{'on':selectParam.put}"><span>使用问题</span></p>
          <p class="question-description" >产品使用报错功能缺失、使用障碍、流程不顺畅</p>
          <p class="question-type" @click.stop="selectParam.others=!selectParam.others" :class="{'on':selectParam.others}"><span>其他问题</span></p>
        </section>
        <section class="question">
          <span class="question-feedback">请简要描述你的问题?</span>
          <em class="question-em">(选填)</em>
          <figure class="input-area">
              <textarea class="input-textArea" placeholder="请输入问题描述">
              </textarea>
          </figure>
        </section>
        <section class="question">
          ...
          <em class="question-em">(选填)</em>
          <figure class="input-area">
            <textarea class="input-textArea" placeholder="请填写QQ号/电话/邮箱">
            </textarea>
          </figure>
        </section>
      </section>
      <button class="btn-primary go-next">提交</button>
    </section>
