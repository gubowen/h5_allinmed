          ...
          <section class="questionItem-common upLoadResource">
            ...
            <section class="questionHiddenCommon upLoadBox" v-show="upload.has">
              <section class="tc-upLoadBox upLoadCommon-box-s">
                ...
                <p class="upLoadContentNum" v-show="imageList1.length>0">已上传{{imageList1.length}}张，<span
                  class="upLoadViewAll" @click="showBigImg( {}, 0 , 1)">查看全部</span></p>
                <!-- <p class="upLoadForPerson"><span class="upLoadForPersonIcon"></span>影像资料是您咨询的重要依据，请尽量上传</p> -->
                <form class="qu-upFormBox qu-upFormBox-s" action="" v-show="false">
                  ...
                  <ul class="qu-upLoadItemBox qu-upLoadItemBox-s docInt">
                    ...
                    <li class="ev-upLoadAdd" v-show="imageList2.length<9">
                      ...
                      <input class="ev-upLoadInput" accept="image/*" type="file"
                             v-if="isIos&&uploading2===false&&imageList2.length<9" @change="onFileChange($event,2)"
                             multiple ref="uploader">
                    </li>
                  </ul>
                </form>
...
// import selectArea from 'components/selectArea';
  ...
  export default {
    ...
    methods: {
      ...
      initData() {
        if (this.patientBaseMessage.optionList) {
          this.allParams.complication = this.patientBaseMessage.complication;
          this.allParams.optionList = JSON.stringify(this.patientBaseMessage.optionList);
          this.allParams.patientId = this.patientBaseMessage.patientId;
        }
      ...
      .questionItem-common {
        ...
        .upLoadForPerson {
          ...
          .upLoadForPersonIcon {
            ...
            top: 50%;
            margin-top: rem(-9px);
            background: url("../../../common/image/img00/consult_V1.2/uploadStar.png") no-repeat center;
            background-size: 100% 100%;
          }
        }
      }
