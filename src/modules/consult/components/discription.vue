...
.pain-level-box {
  ...
  .pain-level-progress {
    ...
    .vue-slider-dot {
      ...
      box-shadow: none;
      background: url(../../../common/image/img00/consult_V1.2/Popups_expression00@2x.png)
        no-repeat;
      background-size: contain;
    }
    &.pain0 {
      background: url(../../../common/image/img00/consult_V1.2/scale00@2x.png)
        no-repeat;
      background-size: contain;
      .vue-slider-dot {
        background: url(../../../common/image/img00/consult_V1.2/Popups_expression00@2x.png)
    ...
    &.pain1 {
      background: url(../../../common/image/img00/consult_V1.2/scale02@2x.png)
        no-repeat;
      background-size: contain;
      .vue-slider-dot {
        background: url(../../../common/image/img00/consult_V1.2/Popups_expression02@2x.png)
          no-repeat;
        background-size: contain;
      }
    }
    &.pain2 {
      background: url(../../../common/image/img00/consult_V1.2/scale03@2x.png)
        no-repeat;
      background-size: contain;
      .vue-slider-dot {
        background: url(../../../common/image/img00/consult_V1.2/Popups_expression03@2x.png)
          no-repeat;
        background-size: contain;
      }
    }
    &.pain3 {
      background: url(../../../common/image/img00/consult_V1.2/scale05@2x.png)
        no-repeat;
      background-size: contain;
      .vue-slider-dot {
        background: url(../../../common/image/img00/consult_V1.2/Popups_expression05@2x.png)
          no-repeat;
        background-size: contain;
      }
    }
    &.pain4 {
      background: url(../../../common/image/img00/consult_V1.2/scale08@2x.png)
        no-repeat;
      background-size: contain;
      .vue-slider-dot {
        background: url(../../../common/image/img00/consult_V1.2/Popups_expression08@2x.png)
          no-repeat;
        background-size: contain;
      }
    }
    &.pain5 {
      background: url(../../../common/image/img00/consult_V1.2/scale09@2x.png)
        no-repeat;
      background-size: contain;
      .vue-slider-dot {
        background: url(../../../common/image/img00/consult_V1.2/Popups_expression09@2x.png)
          no-repeat;
        background-size: contain;
      }
    }
...
.pain-level-title-content {
  ...
  &.pain0 .icon-pain-level-tips {
    background: url(../../../common/image/img00/consult_V1.2/secondary_expression00@2x.png)
      no-repeat;
    background-size: contain;
  }
  &.pain1 .icon-pain-level-tips {
    background: url(../../../common/image/img00/consult_V1.2/secondary_expression02@2x.png)
      no-repeat;
    background-size: contain;
  }
  &.pain2 .icon-pain-level-tips {
    background: url(../../../common/image/img00/consult_V1.2/secondary_expression03@2x.png)
      no-repeat;
    background-size: contain;
  }
  &.pain3 .icon-pain-level-tips {
    background: url(../../../common/image/img00/consult_V1.2/secondary_expression05@2x.png)
      no-repeat;
    background-size: contain;
  }
  &.pain4 .icon-pain-level-tips {
    background: url(../../../common/image/img00/consult_V1.2/secondary_expression08@2x.png)
      no-repeat;
    background-size: contain;
  }
  &.pain5 .icon-pain-level-tips {
    background: url(../../../common/image/img00/consult_V1.2/secondary_expression09@2x.png)
      no-repeat;
    background-size: contain;
  }
